 ...
 *  **get TV Reviews**
 * 
 *  Returns a List of reviews/comments for the selected TV Show.
 *
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
    ...
    const request = await fetch(`https://api.themoviedb.org/3/tv/${tvID}/reviews?api_key=${process.env.TMDB_API_KEY}&language=en-US&page=${page}`);
